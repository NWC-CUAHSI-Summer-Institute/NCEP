...
OUT_DIR = "/Users/aldotapia/Documents/NPET_summer_institute_2026/data/mrms"
CACHE_DIR = os.path.expanduser("~/.mrms_cache")
NAME_OUT = "GaugeCorr_QPE_01H_data.nc"

DATES = ["201805" + str(val).zfill(2) for val in range(20, 32)]
...
for date in DATES:
    ...
    for hh in HHS:
        try:
            data = fetch_iastate("GaugeCorr_QPE_01H", date, hh)
