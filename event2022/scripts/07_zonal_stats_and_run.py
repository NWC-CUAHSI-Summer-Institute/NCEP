"""
Filename: zonal_stats_and_run.py
Author: Aldo Tapia
Date: 2026-07-13
Version: 0.1
Description: Run zonal stats and NGIAB using Docker.
"""
...
YEAR_INI, MONTH_INI, DAY_INI = 2022, 6, 6
YEAR_END, MONTH_END, DAY_END = 2022, 6, 10
...
def main():
    ...
    if not os.path.exists(f"{general_path}/config/"):
        os.makedirs(f"{general_path}/config/")
